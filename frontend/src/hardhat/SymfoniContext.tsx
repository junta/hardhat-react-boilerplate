...
export const ExchangeContext = React.createContext<SymfoniExchange>(emptyContract);
...
export interface SymfoniExchange {
    instance?: Exchange;
    factory?: Exchange__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [Exchange, setExchange] = useState<SymfoniExchange>(emptyContract);
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setExchange(getExchange(_provider, _signer))
    ...
    const getExchange = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contract: SymfoniExchange = {
            instance: instance,
            factory: _signer ? new Exchange__factory(_signer) : undefined,
        }
        return contract
    }
        ;
