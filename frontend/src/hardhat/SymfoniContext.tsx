...
CurrentAddressContext.displayName = "CurrentAddressContext";
...
SymfoniContext.displayName = "SymfoniContext";

export const GreeterContext = React.createContext<SymfoniGreeter>(
  emptyContract
);
GreeterContext.displayName = "GreeterContext";
...
export const Symfoni: React.FC<SymfoniProps> = ({
  ...
  const getGreeter = (_provider: providers.Provider, _signer?: Signer) => {
    ...
    const instance = _signer
      ? Greeter__factory.connect(contractAddress, _signer)
      : Greeter__factory.connect(contractAddress, _provider);
